        ...
        <div className="rounded-lg border border-gray-200 p-4 mt-2">
          ...
          <form ref={formRef} action={handleSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="pain_score">Dolor (1–10)</label>
                <input
                  id="pain_score"
                  name="pain_score"
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="mobility_score">Movilidad (1–10)</label>
                <input
                  id="mobility_score"
                  name="mobility_score"
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="next_session_date">Fecha próxima sesión</label>
                <input
