  ...
  return (
    <main className="p-8 max-w-2xl">
      ...
      <section className="mb-8">
        ...
        {/* Aviso de Privacidad — tarjeta link */}
        <Link
          href={`/${locale}/privacy-policy`}
          className="mt-3 flex items-center justify-between rounded-lg border border-gray-200 p-4 hover:bg-gray-50 transition-colors"
        >
          <div>
            <p className="text-sm font-medium text-gray-800">Aviso de Privacidad</p>
            <p className="text-xs text-gray-500 mt-0.5">Consulta el aviso de privacidad y tratamiento de datos personales.</p>
