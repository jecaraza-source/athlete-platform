...
export default async function CoachProtocolsPage() {
  ...
  const protocol  = await getProtocolByDiscipline('coach');
  ...
  return (
    <main className="p-8 max-w-5xl">
      ...
      <div className="flex items-center justify-between mt-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-blue-700">Protocolo: Entrenador</h1>
          {protocol && (
        ...
        {signedUrl && (
          <a href={signedUrl} download className="rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-100 transition-colors">
            ⤓ Descargar PDF
          </a>
        )}
      </div>
