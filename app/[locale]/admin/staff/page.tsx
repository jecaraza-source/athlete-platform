...
export default async function StaffPage() {
  ...
  return (
    <main className="p-8">
      ...
      <h1 className="text-3xl font-bold mt-4 mb-2 text-rose-700">{t('title')}</h1>
      ...
      <div className="space-y-12">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">{t('administrators')}</h2>
            <NewStaffForm
              hasExtendedColumns={hasExtendedColumns}
              presetRole="admin"
              buttonLabel={t('newAdmin')}
            />
          </div>
          {admins.length === 0 ? (
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">{t('staff')}</h2>
            <NewStaffForm
              hasExtendedColumns={hasExtendedColumns}
